...
last_eval_sat <- as.Date(calc_target_week_end_date(today(), horizon = 0))
...
print(datatable(calibration_table, rownames= FALSE, colnames = c("Model", "n recent forecasts", "Recent 50% coverage", "Recent 95% coverage","n historical forecasts" , "Historical 50% coverage", "Recent 95% coverage"), 
