...
#          forecast_date = as.Date(forecast_date),  
#          submission_sat = as.Date(submission_sat))
# score_cum_edit <- read.csv("score_cum_edit.csv") %>% 
#   mutate(target_end_date = as.Date(target_end_date),
#          forecast_date = as.Date(forecast_date),
#          submission_sat = as.Date(submission_sat))
```
...
plot_byweek_function <- function(df, var, horizon) {
  ggplot(data =  df %>% filter(horizon == "1"), aes(x = submission_sat, y = mean_score, color = model)) +
  ...
  ggtitle(paste0("Average", horizon,"-week ahead ",var," by model")) +
...
by_week_wis_1wk <- plot_byweek_function(byweek_case, var = "wis", horizon = "1")
...
by_week_wis_4wk <- plot_byweek_function(byweek_case, var = "wis", horizon = "4") +
...
by_week_wis_1wk <- plot_byweek_function(byweek_case, var = "coverage_80", horizon = "1") +
...
```{r,fig.width=10, fig.height=6}
by_week_wis_4wk <- plot_byweek_function(byweek_case, var = "coverage_80", horizon = "4") +
  geom_hline(yintercept = 0.8)
...
by_week_wis_1wk <- plot_byweek_function(byweek_inc, var = "wis", horizon = "1") +
  geom_hline(yintercept = 0.8)
ggplotly(by_week_wis_1wk)
```
...
by_week_wis_4wk <- plot_byweek_function(byweek_inc, var = "wis", horizon = "4") +
   geom_line(data = meanwis_1wk, aes(x = submission_sat, y = mean_score), alpha=.5, color = "black", linetype = 2) +
  geom_point(data = meanwis_1wk, aes(x = submission_sat, y = mean_score), alpha=.5, size = 2, color = "black") 
ggplotly(by_week_wis_4wk)
```
...
by_week_wis_1wk <- plot_byweek_function(byweek_inc, var = "coverage_80", horizon = "1") +
  geom_hline(yintercept = 0.8)
ggplotly(by_week_wis_1wk)
```
...
The black line represents 80% 
```{r,fig.width=10, fig.height=6}
by_week_wis_4wk <- plot_byweek_function(byweek_inc, var = "coverage_80", horizon = "4") +
  geom_hline(yintercept = 0.8)
...
###1 Week Horizon WIS
```{r,fig.width=10, fig.height=6}
byweek_cum <- by_week_function(score_cum_edit, var = "wis")
by_week_wis_1wk <- plot_byweek_function(byweek_cum, var = "wis", horizon = "1") +
  geom_hline(yintercept = 0.8)
ggplotly(by_week_wis_1wk)
```
...
by_week_wis_4wk <- plot_byweek_function(byweek_cum, var = "wis", horizon = "4") +
   geom_line(data = meanwis_1wk, aes(x = submission_sat, y = mean_score), alpha=.5, color = "black", linetype = 2) +
  geom_point(data = meanwis_1wk, aes(x = submission_sat, y = mean_score), alpha=.5, size = 2, color = "black") 
ggplotly(by_week_wis_4wk)
```
...
The black line represents 80% 
```{r,fig.width=10, fig.height=6}
byweek_inc <- by_week_function(score_cum_edit, var = "coverage_80")
by_week_wis_1wk <- plot_byweek_function(byweek_inc, var = "coverage_80", horizon = "1") +
  geom_hline(yintercept = 0.8)
ggplotly(by_week_wis_1wk)
```
...
```{r,fig.width=10, fig.height=6}
by_week_wis_4wk <- plot_byweek_function(byweek_cum, var = "coverage_80", horizon = "4") +
  geom_hline(yintercept = 0.8)
...
##Location Specific WIS
```{r fig.height=10, fig.width= 11}
plot_avg_by_loc(score_cum_edit)
```
