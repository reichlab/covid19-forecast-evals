...
county_fips <- hub_locations %>%  filter(geo_type == "county") %>% filter(abbreviation %in% datasets::state.abb) %>% pull(fips) #counties 
...
truth_function <- function(x) {
  load_truth(
    ...
    locations = c(the_locations,county_fips))
}
...
save(score_case_x1_all, file = "reports/score_case_x1_all_county.rda")
save(score_case_x2_all, file = "reports/score_case_x2_all_county.rda")
save(score_case_x3_all, file = "reports/score_case_x3_all_county.rda")
save(score_case_x4_all, file = "reports/score_case_x4_all_county.rda")

load(file = "reports/score_case_x1_all_county.rda")
load(file = "reports/score_case_x2_all_county.rda")
load(file = "reports/score_case_x3_all_county.rda")
load(file = "reports/score_case_x4_all_county.rda")
...
save(score_case_all, file = "reports/score_case_all_county.rda")
save(truth_dat_case, file = "reports/truth_dat_case_county.rda")
save(truth_dat_case_all, file = "reports/truth_dat_case_all_county.rda")
