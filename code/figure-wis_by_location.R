...
fig_wis_loc <- ggplot(to_plot_phase %>% filter(seasonal_phase != "winter"), aes(x = tidytext::reorder_within(model,order_wis,seasonal_phase),
...
library(cowplot)
pdf(file = "figures/fig-wis-location_phase.pdf", width=8, height=12)
ggdraw(plot_grid(
