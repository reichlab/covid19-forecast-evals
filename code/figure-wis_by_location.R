...
scores <- spring_phase %>% select("model", "forecast_date", "location", "location_name", "horizon", "abs_error", "wis") %>% droplevels()
...
scores <- summer_phase %>% select("model", "forecast_date", "location", "location_name", "horizon", "abs_error", "wis") %>% droplevels()
...
scores <- winter_phase %>% select("model", "forecast_date", "location", "location_name", "horizon", "abs_error", "wis") %>% droplevels()
