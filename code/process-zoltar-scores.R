...
## write to disk
write_csv(cum_scores_eligible, path = paste0("paper-inputs/20201013-cum-scores.csv"))
write_csv(inc_scores_eligible, path = paste0("paper-inputs/20201013-inc-scores.csv"))

write_csv(cum_scores_calc, path = paste0("paper-inputs/20201013-cum-scores_all.csv"))
write_csv(inc_scores_calc, path = paste0("paper-inputs/20201013-inc-scores_all.csv"))
