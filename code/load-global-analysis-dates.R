...
truth_date <- as.Date("2021-11-16")
  # previously as.Date("2021-10-18") 
  # previously as.Date("2021-05-25") 
  #previously 2021-05-03

## spreadsheet for keeping track of dates
## https://docs.google.com/spreadsheets/d/1u6PTlQoNgIyWwE_msswftg2P3U0JOmt5pwIRciAq0Wk/edit#gid=1491635626
...
last_timezero <- as.Date("2021-10-25") #as.Date("2021-09-27") #previously as.Date("2021-04-26") ## latest forecast_date for 1 wk ahead in an eligible file, based on 1 wk ahead. 
last_timezero4wk <- as.Date("2021-10-04") #as.Date("2021-09-06") #previously as.Date("2021-04-05") ## latest forecast_date for 4 wk ahead in an eligible file
...
the_target_end_dates <- seq(from = first_target_end_date, last_target_end_date, by = "week") #79 target_end_dates 

  
## maximum number of weeks missing that we allow before disqualifying a model
MAXIMUM_MISSING_WEEKS <- 73 #79 total target_end_dates, need to have submitted at a minimum 6 weeks for inclusion in spring
                            #75 total target_end_dates, need to have submitted at a minimum 6 weeks for inclusion in spring
...
MAXIMUM_MISSING_WEEKS_OVERALL <- round(num_weeks_forecasted*0.4, 0) #missing up to 32 weeks #Team can be missing up to 40% #formerly 21. #changed b/c there are 53 weeks and 53*0.6 = 31.8 #formerly 17 #formerly 3 

NUM_WEEKS_INC <- num_weeks_forecasted - MAXIMUM_MISSING_WEEKS_OVERALL  #47 #for inclusion overall, must have submitted at least 60% of weeks
